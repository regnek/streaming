          ...
          <div className="flex items-center">
            <Link href="/">
              <svg width="120" height="36" viewBox="0 0 120 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                  d="M28.8118 17.9142V20.2218H21.6767V23.4258H28.1719V25.6381H21.6767V31.493H19.0592V17.9142H28.8118Z"
                  fill="#F50600"
                />
                <path
                  d="M81.627 4.3354C81.8403 4.3354 82.0342 4.35448 82.2281 4.37355V6.58582H81.6076C80.6769 6.58582 79.9596 6.83375 79.4555 7.29146C78.9514 7.74917 78.7187 8.43574 78.7187 9.33209V14.3288H76.2757V4.48798H78.6411V6.24254C79.184 4.98383 80.1922 4.3354 81.627 4.3354Z"
                  fill="#F50600"
                />
                <path
                  d="M74.6982 9.58002V10.1522H67.2142C67.2917 10.9913 67.5632 11.6397 68.0091 12.0593C68.455 12.4789 69.0561 12.6886 69.8123 12.6886C70.9174 12.6886 71.6736 12.2309 72.1001 11.2774H74.4462C74.1747 12.2881 73.6318 13.0891 72.8175 13.6803C71.9838 14.2716 70.9756 14.5576 69.7929 14.5576C68.2999 14.5576 67.0978 14.0999 66.1865 13.1464C65.2559 12.2119 64.8099 10.9722 64.8099 9.40837C64.8099 7.8636 65.2559 6.62396 66.1672 5.6704C67.0784 4.7359 68.2805 4.25912 69.7541 4.25912C71.2664 4.25912 72.4685 4.75497 73.3604 5.72761C74.2523 6.71932 74.6982 7.9971 74.6982 9.58002ZM69.7347 6.12811C68.2999 6.12811 67.4662 6.91003 67.2335 8.47388H72.2553C72.1389 7.74917 71.8675 7.17703 71.4409 6.75746C70.995 6.33789 70.4327 6.12811 69.7347 6.12811Z"
                  fill="#F50600"
                />
                <path
                  d="M60.9186 5.84204V4.48798H63.284V14.0046C63.284 15.3396 62.838 16.3885 61.9849 17.1513C61.1318 17.9142 59.9103 18.2956 58.3398 18.2956C56.9438 18.2956 55.8387 17.9905 55.0438 17.3802C54.2488 16.7699 53.8223 15.9308 53.7447 14.8628H56.1489C56.2652 15.9308 57.002 16.4457 58.3786 16.4457C59.1736 16.4457 59.7746 16.255 60.2012 15.8354C60.6277 15.4349 60.841 14.8437 60.841 14.0618V12.8221C60.1042 13.8138 59.096 14.2906 57.7776 14.2906C56.4203 14.2906 55.3152 13.8329 54.5009 12.8984C53.6671 12.0021 53.26 10.8006 53.26 9.27487C53.26 7.74917 53.6671 6.54768 54.5009 5.63225C55.3152 4.71683 56.401 4.25912 57.7582 4.25912C59.1542 4.25912 60.2206 4.79312 60.9186 5.84204ZM58.3204 12.3072C59.1348 12.3072 59.7552 12.0402 60.2206 11.5062C60.6665 10.9722 60.8992 10.2284 60.8992 9.27487C60.8992 8.32131 60.6665 7.57753 60.2206 7.04353C59.7552 6.50953 59.1348 6.24254 58.3204 6.24254C57.5255 6.24254 56.9051 6.52861 56.4397 7.0626C55.9744 7.5966 55.7611 8.34038 55.7611 9.29395C55.7611 10.2475 55.9744 10.9722 56.4397 11.5062C56.9051 12.0402 57.5255 12.3072 58.3204 12.3072Z"
                  fill="#F50600"
                />
                <path
                  d="M48.211 4.25912C49.2968 4.25912 50.1499 4.58333 50.7703 5.19361C51.3908 5.8039 51.7204 6.68118 51.7204 7.80638V14.3288H49.2774V8.20688C49.2774 6.96725 48.6376 6.33789 47.3967 6.33789C46.7762 6.33789 46.2334 6.56675 45.8068 7.00539C45.3803 7.44403 45.167 8.05431 45.167 8.81716V14.3288H42.724V4.48798H45.0894V5.89925C45.8456 4.81219 46.8926 4.25912 48.211 4.25912Z"
                  fill="#F50600"
                />
                <path
                  d="M41.1465 9.58002V10.1522H33.6624C33.74 10.9913 34.0114 11.6397 34.4574 12.0593C34.9033 12.4789 35.5044 12.6886 36.2605 12.6886C37.3657 12.6886 38.1219 12.2309 38.5484 11.2774H40.8945C40.623 12.2881 40.0801 13.0891 39.2658 13.6803C38.4321 14.2716 37.4239 14.5576 36.2412 14.5576C34.7482 14.5576 33.5461 14.0999 32.6348 13.1464C31.7042 12.2119 31.2582 10.9722 31.2582 9.40837C31.2582 7.8636 31.7042 6.62396 32.6155 5.6704C33.5267 4.7359 34.7288 4.25912 36.2024 4.25912C37.7147 4.25912 38.9168 4.75497 39.8087 5.72761C40.7006 6.71932 41.1465 7.9971 41.1465 9.58002ZM36.183 6.12811C34.7482 6.12811 33.9145 6.91003 33.6818 8.47388H38.7035C38.5872 7.74917 38.3158 7.17703 37.8892 6.75746C37.4433 6.33789 36.881 6.12811 36.183 6.12811Z"
                  fill="#F50600"
                />
                <path
                  d="M28.1332 0.75H31.3905L25.7096 6.28068L31.3905 14.3288H28.2689L23.8482 7.9971L21.6767 10.0759V14.3288H19.0592V0.75H21.6767V7.15796L28.1332 0.75Z"
                  fill="#F50600"
                />
                <path
                  d="M32.4278 19.0966C32.4278 19.8339 31.8201 20.4316 31.0706 20.4316C30.321 20.4316 29.7133 19.8339 29.7133 19.0966C29.7133 18.3593 30.321 17.7616 31.0706 17.7616C31.8201 17.7616 32.4278 18.3593 32.4278 19.0966Z"
                  fill="#F50600"
                />
                <path
                  d="M72.9988 19.0966C72.9988 19.8339 72.3912 20.4316 71.6416 20.4316C70.892 20.4316 70.2844 19.8339 70.2844 19.0966C70.2844 18.3593 70.892 17.7616 71.6416 17.7616C72.3912 17.7616 72.9988 18.3593 72.9988 19.0966Z"
                  fill="#F50600"
                />
                <path
                  d="M16.5 5.93579V6.27856H12.2762C12.3315 6.67661 12.4753 6.97515 12.7075 7.17418C12.9286 7.38426 13.2271 7.48378 13.581 7.48378C14.1338 7.48378 14.5208 7.27369 14.7309 6.84247H16.3673C16.2125 7.43955 15.8808 7.90394 15.3832 8.24671C14.8746 8.58948 14.2775 8.75533 13.581 8.75533C12.6964 8.75533 11.9777 8.48996 11.4359 7.93711C10.883 7.39532 10.6177 6.67661 10.6177 5.76994C10.6177 4.86326 10.883 4.14456 11.4248 3.60276C11.9556 3.06097 12.6632 2.78455 13.5588 2.78455C14.4434 2.78455 15.1511 3.07203 15.7039 3.63594C16.2346 4.2109 16.5 4.98489 16.5 5.93579ZM13.5367 4.0561C12.8291 4.0561 12.4089 4.43204 12.2873 5.18392H14.8083C14.7419 4.83009 14.6093 4.55367 14.3881 4.35464C14.167 4.15562 13.8795 4.0561 13.5367 4.0561Z"
                  fill="#F50600"
                />
                <path
                ...
                />
                <path
                  d="M3.67093 2.91719V4.17769H2.57628V6.84243C2.57628 7.04145 2.62051 7.17414 2.72003 7.24048C2.80848 7.30682 2.98539 7.33999 3.22865 7.33999H3.67093V8.62261C3.46085 8.65578 3.19548 8.66683 2.87482 8.66683C2.15612 8.66683 1.63644 8.54521 1.32684 8.2909C1.00619 8.03658 0.85139 7.61642 0.85139 7.0304V4.17769H0V2.91719H0.85139V1.22546H2.57628V2.91719H3.67093Z"
                  fill="#F50600"
                />
              </svg>
            </Link>

...
export function VideoPlayer({
  ...
  useEffect(() => {
    const checkAutoplaySupport = async () => {
      try {
        ...
        testVideo.src =
          "data:video/mp4;base64,"
  ...
  // Update the HLS streaming setup to handle both TV episodes and movies
  useEffect(() => {
    const video = videoRef.current
    if (!video) return

    // Determine the streaming URL based on the videoId format
    let streamingSrc = src // Default to the src prop

    if (videoId) {
      // Check if this is a TV episode (format: episode-{showId}-{seasonNumber}-{episodeNumber})
      if (videoId.startsWith("episode-")) {
        ...
        if (parts.length >= 4) {
          ...
          // Generate dynamic streaming URL for TV episodes
          streamingSrc = `https://d36cjdeusqqqhg.cloudfront.net/Shows/${showId}/${seasonNumber}/${episodeNumber}/${episodeNumber}_master.m3u8`
          console.log(`Generated dynamic streaming URL for TV episode: ${streamingSrc}`)
        }
      }
      // Check if this is a movie (format: movie-{movieId})
      else if (videoId.startsWith("movie-")) {
        const parts = videoId.split("-")
        if (parts.length >= 2) {
          // Extract the movieId (could be a simple ID or contain hyphens)
          const movieId = parts.slice(1).join("-")

          // Generate dynamic streaming URL for movies
          streamingSrc = `https://d36cjdeusqqqhg.cloudfront.net/Movies/${movieId}/${movieId}_master.m3u8`
          console.log(`Generated dynamic streaming URL for movie: ${streamingSrc}`)
        }
      }
      // Handle legacy or simple IDs that don't follow the new format
      else {
        // Assume it's a movie with a simple ID
        const movieId = videoId
        streamingSrc = `https://d36cjdeusqqqhg.cloudfront.net/Movies/${movieId}/${movieId}_master.m3u8`
        console.log(`Generated dynamic streaming URL for legacy movie ID: ${streamingSrc}`)
      }
    }
